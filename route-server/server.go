...
// check if a point is inside a rectanglev
...
func main() {
	...
	if err != nil {
		log.Fatalln("canont create a listener at the address")
	}
	grpcServer := grpc.NewServer()
	guideServer := newServer()
	pb.RegisterRouteGuideServer(grpcServer, guideServer)
